...
from app.models.request_models import PatientProfile, LocationData
from app.models.response_models import AnalyzeResponse, Diagnosis, SeverityLevel, Urgency, DoctorResult
...
async def analyze_symptoms(
    ...
    return AnalyzeResponse(
        ...
        urgency=Urgency(
            ...
            action_plan=["Rest in a dark room", "Take over the counter pain medication"],
